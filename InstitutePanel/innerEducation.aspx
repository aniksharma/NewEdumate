<%@ Page Title="" Language="C#" MasterPageFile="~/InstitutePanel/MasterPage2.master" AutoEventWireup="true" CodeFile="innerEducation.aspx.cs" Inherits="InstitutePanel_innerEducation" %>
...
<p class="paras-001"><span class="hdng-addr"><%=linkemail%> </span> <%--<%=linkaddress%>--%></br>
</p>
<p class="paras-002"><span class="hdng-addr"> </span><%--<%=linkemail%>--%></p>
 

  <div style="padding-bottom: 2px; padding-right: 85px" align="center">
