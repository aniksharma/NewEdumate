<%@ Page Title="" Language="C#" MasterPageFile="~/InstitutePanel/MasterPage2.master" AutoEventWireup="true" CodeFile="InnerCollege.aspx.cs" Inherits="InstitutePanel_InnerCollege" %>
...
<p class="artcless-img-02"><a href ="#"><img src="http://www.edumateworld.com/<%=linkimage%>" id="img<%=i%>image" class="img-size"/></a></p>


<div class="artcless-container">
<h5 class="hdng-03"><a href ="#"> <%=linkuniname%></a></h5>
<p class="paras-001"><span class="hdng-addr">Category :- </span> <%=Category%></br>
</p>
<p class="paras-002"><span class="hdng-addr">Email :- </span><%=linkemail%></p>
  ...
  <div style="padding-bottom: 2px; padding-right: 150px" align="center">
        <%--<a class="readmore" target ="_blank" href="../TeacherDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a>--%>
        <a class="readmore" target="_blank" href="../mktclg/<%=Collegeid%>/<%=cntid%>/<%=linkuniname%> ">ViewDetails...</a>
        </div>
