<%@ Page Title="" Language="C#" MasterPageFile="~/InstitutePanel/MasterPage2.master" AutoEventWireup="true" CodeFile="innerCareer.aspx.cs" Inherits="InstitutePanel_innerCareer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <script>
    ...
    <div>
<div>
<asp:DropDownList ID ="ddl" runat ="server" class="slct-fld" 
 onselectedindexchanged="ddl_SelectedIndexChanged" AutoPostBack ="true"></asp:DropDownList> </div>
