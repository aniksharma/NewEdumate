<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EducationBoard.aspx.cs" Inherits="EducationBoard" %>
                ...
                <table id='tablepaging'>
                    <% 
                        for (int i = 0; i < TotalCount; i++)
                        {
                            ...
                            string linkuniname = ds.Tables[0].Rows[i]["EducationTitle"].ToString();
                           string linkimage = ds.Tables[0].Rows[i]["newImage"].ToString();
                           string TextDetails = ds.Tables[0].Rows[i]["subTitle"].ToString();
                    %>
                    <tr>
...
<a target="_blank" href="educationboardprev.aspx?uniid=<%=Newsid%>">
    <h5 class="hdng-03"> <%=linkuniname%></h5></a>
   <p class="paras-001"><%=TextDetails %>.</p>
  <div style="padding-bottom: 2px; padding-right: 5px" align="center">
                ...
                <div id="pageNavPosition" style="cursor: pointer; padding-top: 0; margin-bottom: 25px;"
                    align="center">
                </div></div>
            <script type="text/javascript"><!--
