<%@ Page Title="" Language="C#" MasterPageFile="~/manage2/NewWeb/home2.master" AutoEventWireup="true" CodeFile="Student-Group.aspx.cs" Inherits="manage2_NewWeb_Student_Group" %>
...
<article class="artcless-middle">
               ...
               <%
                   for (int i = 0; i < totalcount; i++)
                   {
                       ...
                       string Collegeid = ds1.Tables[0].Rows[i]["logo"].ToString();
                       string title = ds1.Tables[0].Rows[i]["KName"].ToString();
                       string code = ds1.Tables[0].Rows[i]["SCode"].ToString();
