<%@ Page Title="" Language="C#" MasterPageFile="~/manage2/NewWeb/home2.master" AutoEventWireup="true"
    CodeFile="pagedata.aspx.cs" Inherits="manage2_NewWeb_pagedata" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="main-container-001" id="common" runat="server">
...
<div style="width: 100%; background-color: White" id="galary" runat="server">
    
  <asp:LinkButton ID="LinkButton1" CssClass="linkbutton"
