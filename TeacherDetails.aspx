<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherDetails.aspx.cs" Inherits="TeacherDetails" %>
...
<p class="paras-002"><span class="hdng-addr">Email :- </span><%=linkemail%></p>
  ...
  <div class="test-workspace">
        ...
        <div style="display: Blick;" id="workspace">
    ...
    <div class="tab_container" id ="tyty" style="display:block; width:675px;overflow-x:hidden;">
     ...
     %>
    	...
    	<%--<a  id ="imageLink" href="~/<%=Title%>"><img src="~/<%=Title%>" alt=""  rel="prettyPhoto[gallery]" class="galcategory" width="168px" height="88px" /></a>--%>
     ...
     <%--<p class="artcless-img-02"><img src="~/<%=Title%>" id="img1" width="168px" height="88px" /> </p>--%>
     <%} %>
      ...
      <%--  <div id="tab6<%=i%>" class="tab_content">
            <h2><a target ="_blank" href="http://<%=UniWebsite%>">GoTo-Website</a></h2>--%>
       <!--     <a href="#"> <img src="estebanmunoz_thumb.gif" alt="" /></a>-->
