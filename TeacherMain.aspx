<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherMain.aspx.cs" Inherits="TeacherMain" %>
...
<body>
    ...
    <div>
     ...
     for (int i = 0; i < TotalCount; i++)
     {
         ...
         string Collegeid = ds.Tables[0].Rows[i]["id"].ToString();
...
<p class="paras-002"><span class="hdng-addr">Email :- </span><%=linkemail%></p>
   ...
   <div style="padding-bottom: 2px; padding-right: 150px" align="center">
       <%-- <a class="readmore" target ="_blank" href="InsDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a></div>--%>
    
        <a class="readmore" target ="_blank" href="TeacherDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a></div>
