<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PageData1.aspx.cs" Inherits="mange3_PageData1" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat ="server"></asp:ScriptManager>
     <div id="data" runat="server">
        ...
        <div style="display: block; background :white ;width:996px;" id="workspace">
