...
<head>
    ...
    <title>Wordpress Mass Defacer Private by Teamr00t</title>
    
	<p>
	<h2 style="color:#FF0000;text-align: center;">Wordpress Mass Defacer Private by Teamr00t</h2>
	<style type="text/css">
        body {color: white; background: #000 url(http://i47.tinypic.com/pq0xi.jpg) no-repeat 50% 50%;font-family: "Trebuchet MS",Arial;background-attachment:fixed;margin:0;padding:0;}
...
<body>
<div class="footer">
    <h3 style="text-align: center;">Coded By Teamr00t</h3>
</div>
