<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UniversityMain.aspx.cs" Inherits="UniversityMain"
...
<p class="paras-002"><span class="hdng-addr">Email :- </span><%=linkemail%></p>
  ...
  <div style="padding-bottom: 2px; padding-right: 150px" align="center">
      <a class="readmore" target ="_blank" href="ViewUniDetails.aspx?Unid=<%=uniID%> /<%=UniCont%>">ViewDetails...</a></div>
