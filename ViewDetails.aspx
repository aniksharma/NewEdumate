...
<p class="artcless-img-02"><img src="~/<%=linkimage%>" id="img<%=i%>image" width="168px" height="88px" /> </p>
...
<p class="paras-002"><span class="hdng-addr">Email :- </span><%=linkemail%></p>
  ...
  <div style="padding-bottom: 2px; padding-right: 5px" align="right">
        <a class="readmore" href="ViewDetails.aspx"> ViewDetails...</a></div>
