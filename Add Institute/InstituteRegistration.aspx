<%@ Page Title="" Language="C#" MasterPageFile="~/Add Institute/MasterPage.master"
    AutoEventWireup="true" CodeFile="InstituteRegistration.aspx.cs" Inherits="Add_Institute_InstituteRegistration" %>
                                ...
                                <table cellpadding="0px" cellspacing="0px">
                                    <tr>
                                        <td style="width: auto; height: 32px; float: left; font-family: Arial, Helvetica, sans-serif;
                                            ...
                                            <span lang="EN-IN" style="font-size: 10.5pt; line-height: 115%; font-family: sans-serif, 'color: #333333';">
                                                Welcome, Kindly fill the form below with all accurate information about your College
                                                and then click the submit button below.<![if !supportLineBreakNewLine]><br />
                                                <![endif]></span>
                                                            ...
                                                            <div>
                                                                <table width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right">
                                                                            <asp:Button ID="btOk" runat="server" CausesValidation="False" PostBackUrl="../Default.aspx"
                                                                                Text="Ok" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                    ...
                                                    <td>
                                                        <table style="width: 100%;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtemail" runat="server" AutoPostBack="True" CssClass="txts-flds"
                                                                        onblur="javascript:Email('ContentPlaceHolder1_txtemail')" onchange="ddlChkSelect('txt');"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtpassword" runat="server" CssClass="txts-flds" onblur="javascript:Password('ContentPlaceHolder1_txtpassword')"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="height: 30px">
                                                                    <asp:TextBox ID="txtpassVaryfy" runat="server" CssClass="txts-flds" onblur="javascript:VaryfyPassword('ContentPlaceHolder1_txtpassVaryfy')"
                                                                        TextMode="Password"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                <td colspan="2">
                                                                    <table width="100%">
                                                                        ...
                                                                        <tr>
                                                                            <td class="hdng-topics" colspan="2" style="text-align: left;">
                                                                                Course Details
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 175px;">
                                                                                Course Category <span style="color: #FF0000">*</span>
                                                                            </td>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" CssClass="txts-drps"
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 175px;">
                                                                                Course Sub Category <span style="color: #FF0000">*</span>
                                                                            </td>
                                                                            <td>
                                                                                <asp:DropDownList ID="ddlSubCategory" runat="server" AutoPostBack="True" CssClass="txts-drps">
                                                                                </asp:DropDownList>
