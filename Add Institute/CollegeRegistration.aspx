<%@ Page Title="" Language="C#" MasterPageFile="~/Add Institute/MasterPage.master"
    AutoEventWireup="true" CodeFile="CollegeRegistration.aspx.cs" Inherits="Add_Institute_CollegeRegistration" %>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table width="100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                           <asp:DropDownList ID="ddlCourseLevel" runat="server" CssClass="txts-drps">
                                                                            ...
                                                                            <span id="Span4" style="width: 50px; float: none;"></span>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="ddlCourseLevel"
                                                                                ErrorMessage="It is Required" ValidationGroup="t"></asp:RequiredFieldValidator>
                                                                            <div id="Div4" style="visibility: hidden; height: 24px; width: 24px; float: right;
                                                                                margin-right: 65px; margin-top: -24px;">
                                                                                <img alt="Loading..." src="../images/loading.gif" style="width: 22px; height: 22px" />
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 175px;">
                                                                            Affiliated<span style="color: #FF0000">*</span>
                                                                        </td>
                                                                        <td>
                                                                            <asp:DropDownList ID="ddlUniversityFinal" runat="server" CssClass="txts-drps">
                                                                                                    </asp:DropDownList>
                                                                            <span id="Span6" style="width: 50px; float: none;"></span>
                                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="ddlUniversityFinal"
                                                                                ErrorMessage="It is Required" ValidationGroup="t"></asp:RequiredFieldValidator>
                                                                            <div id="Div6" style="visibility: hidden; height: 24px; width: 24px; float: right;
                                                                                margin-right: 65px; margin-top: -24px;">
                                                                                <img alt="Loading..." src="../images/loading.gif" style="width: 22px; height: 22px" />
                                                                            </div>
                                                                        </td>
