<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CollegeMain.aspx.cs" Inherits="CollegeMain" %>
...
<body>
    ...
    <div>
        ...
        <div class="left-sectn">
            &nbsp;
            <asp:DropDownList ID="ddlNopage" Visible="false" runat="server" CssClass="DropdwonShort"
...
<br />
   <div style="padding-bottom: 2px; padding-right: 150px" align="center">
        ...
        <a class="readmore" style="float:none;" target ="_blank" href="CollegeDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a>
        <a class="readmore" style="float:none;" target ="_blank" href="CollegeDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a>
        <a class="readmore" style="float:none;" target ="_blank" href="CollegeDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a>
        <a class="readmore" style="float:none;" target ="_blank" href="CollegeDetails.aspx?Unid=<%=Collegeid%> /<%=cntid%>/">ViewDetails...</a>
