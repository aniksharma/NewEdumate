<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AddCollegeListing.aspx.cs" Inherits="Admin_web_AddCollegeListing" %>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnAddNewEmployee" CausesValidation="false" runat="server" Style="width: 140px;"
                                        CssClass="bnt-sbmt" OnClick="btnAddNewEmployee_Click" Text="Add College" />
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="ImportCollegeFromExcel.aspx">Import College</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="H1Center">
                                                                                               ...
                                                                                               <%-- <td class="H2Left" style="display:none;">--%>
                                                                                                ...
                                                                                                <td class="H1Left" id="tdUniverciyDdl" runat="server">
                                                                                                    <asp:DropDownList ID="ddlUniversityFinal" runat="server" CssClass="DropdwonMid">
                                                                                                      ...
                                                                                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="ddlUniversityFinal"
                                                                                                        Display="None" ErrorMessage="Select Affiliated !" InitialValue="0"></asp:RequiredFieldValidator>
