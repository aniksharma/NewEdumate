...
public partial class Admin_web_AddCountry : System.Web.UI.Page
{
    clsBLSetup obj;
    ...
    private void updateValue()
    {
        ...
        objprp.id = Id;
        objprp.name = txtUserName.Text;
        lblMsg.Text = obj.UpdCountry(objprp);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        obj = new clsBLSetup();
        objparm.id = Id;
        lblMsg.Text = obj.DelCountry(objparm);
        bindlist();
        txtUserName.Text = "";
        txtUserName.Focus();
        btnDelete.Visible = false;
