...
public partial class Admin_web_ImageCategory : System.Web.UI.Page
{
    clsBLSetup obj;
    ...
    private void bindlist()
    {
        ...
        objprpdrp.spName = "viewImageCategory";
    ...
    private void BindTextboxes()
    {
        ...
        objprp = obj.SelImageCategory(objparm);
        Id = objprp.id;
    ...
    private void insertValue()
    {
        ...
        lblMsg.Text = obj.InsImageCategory(objprp);
    }
    private void updateValue()
    {
        ...
        objprp.uniID = ddlUniversity.SelectedValue;
        objprp.isActive = rblStatus.SelectedValue;
        lblMsg.Text = obj.UpdImageCategory(objprp);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        obj = new clsBLSetup();
        objparm.id = Id;
        lblMsg.Text = obj.DelImageCategory(objparm);
        bindlist();
        txtUserName.Text = "";
        txtUserName.Focus();
        btnDelete.Visible = false;
