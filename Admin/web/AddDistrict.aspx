<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AddDistrict.aspx.cs" Inherits="Admin_web_AddDistrict" %>
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td class="Add-Country" colspan="2">
                                                                Add District&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ImportDist.aspx">Import District</a></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                State:&nbsp;</td>
                                                            <td>
                                                                <asp:DropDownList ID="ddlUniversity" runat="server" CssClass="txt-fld-Dropdown" onblur="javascript:DropDown('ctl00_ContentPlaceHolder1_ddlUniversity')" Onchange="ddlChkSelect('State');"
                                                                 ...
                                                                 <span id="ctl00_ContentPlaceHolder1_ddlUniversityL" style="width: 50px; float: none;"></span>
                                                        ...
                                                        <td>&nbsp;</td>
                                                            <td class="H1Center" colspan="2">
                                                                <asp:Button ID="btnSubmit" runat="server" CssClass="bnt-sbmt" OnClick="btnSubmit_Click" OnClientClick="ddlChkSelect('Submit');" onfocus="javascript:submitDistictdata();"
