<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AcademicRequest.aspx.cs" Inherits="Admin_web_AcademicRequest" %>
                                       ...
                                       <tr>  <td style="width: 1">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="width: 98%">
                                                ...
                                                <tr>
                                                <th>ID</th><th>Type</th><th>Category</th><th>Sub_Category</th><th>Title</th><th>Request</th>
                                                <th>Address</th><th>EmailID</th><th>Mobile-no</th><th>Name</th> <th>Date</th><th>Action</th></tr>
                                                </HeaderTemplate>                                                
                                                <ItemTemplate>
                                                <tr>
                                                <td><%#Eval("AcdRequest_Id")%></td><td><%#Eval("mailId")%></td><td><%#Eval("city")%></td><td><%#Eval("description")%></td><td><%#Eval("state")%></td>
                                               <td><%#Eval("DOB")%></td><td><%#Eval("address")%></td><td><%#Eval("emailID")%></td><td><%#Eval("mobNo")%></td><td><%#Eval("Type")%></td>
                                               <td><%#Eval("Password")%></td>
                                                  <td>
                                                                <asp:LinkButton ID="lnkDelete" CausesValidation="false" runat="server" CommandArgument='<%#Eval("AcdRequest_Id")%>'
