<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="TextCategory.aspx.cs" Inherits="Admin_web_TextCategory" %>
                                            ...
                                            <tr>
                                                <td valign="top" width="80%">
                                                    <table style="width: 100%">
                                                        ...
                                                        <td>&nbsp;</td>
                                                            <td class="H1Center" colspan="2">
                                                                <asp:Button ID="btnSubmit" runat="server" CssClass="bnt-sbmt" OnClick="btnSubmit_Click"  OnClientClick="ddlChkSelect('Submit');" onfocus="javascript:submitTextCatagorydata();"
