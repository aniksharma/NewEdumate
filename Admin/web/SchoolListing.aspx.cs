...
public partial class Admin_web_SchoolListing : System.Web.UI.Page
{
    PRPSetup prppram;
    PRPSetup prp;
    clsBLSetup bl;
    ...
    private void insertBranch(String st)
    {
        ...
        prp.nneSMS = "0";
        prp.title ="3";  //Type Id for School
    ...
    #endregion
    protected void ApprovedBy_SelectedIndexChanged(object sender, EventArgs e)
    {
