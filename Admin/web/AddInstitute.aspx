<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="AddInstitute.aspx.cs" Inherits="Admin_web_AddInstitute" %>
                                                                ...
                                                                <div>
                                                                    <table width="100%">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right">
                                                                                <asp:Button ID="btOk" runat="server" Text="Ok" PostBackUrl="AddInstitute.aspx" CausesValidation="False" />
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </div>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td style="width: 177px;">
                                                                        <span style="color: #FF0000">*</span>Type
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <table width="100%">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <span style="color: #FF0000">*</span>Institute
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="width: 175px;">
                                                                                    <span style="color: #FF0000">*</span>Institute Category
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td style="width: 175px;">
                                                                                    <span style="color: #FF0000">*</span>Institute Sub Category
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:DropDownList ID="ddlCountry" runat="server" AutoPostBack="True" onblur="javascript:DropDown('ContentPlaceHolder1_ddlUniversity')"
                                                                                        CssClass="DropdwonMid" Width="230px" Onchange="ddlChkSelect('State');" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged">
                                                                                    </asp:DropDownList>
            ...
            <td>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnSubmit" runat="server" Style="width: 134px; height: 40px;" Text="Submit"
                                OnClick="Button1_Click" CssClass="orange-button" OnClientClick="javascript:submitdata();"
                                onfocus="javascript:submitdata();" ValidationGroup="t" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
