...
public partial class Admin_web_ImportCity : System.Web.UI.Page
{
    ...
    private void GenerateExcelData()
    {
        ...
        { //FileInfo file = new FileInfo(FileUpload1.FileName);
            ...
            for (a = 0; a < TotalRow; a++)
            {
                ...
                objprp.name = ds.Tables[0].Rows[a][1].ToString();// City;
                objprp.uniID = ds.Tables[0].Rows[a][2].ToString();// Dist Id;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Warrning.InnerHtml = "<div class='message error'> <h5>City data</h5> <p>Submit Successfully !! </p> </ div>";
            }
