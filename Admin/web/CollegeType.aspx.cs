...
public partial class Admin_web_CollegeType : System.Web.UI.Page
{
    clsBLSetup obj;
    ...
    private void bindlist()
    {
        ...
        objprpdrp.spName = "viewCollegeType";
    ...
    private void BindTextboxes()
    {
        ...
        objprp = obj.SelCollegeType(objparm);
        Id = objprp.id;
    ...
    private void insertValue()
    {
        ...
        lblMsg.Text = obj.InsCollegeType(objprp);
    }
    private void updateValue()
    {
        ...
        objprp.name = txtUserName.Text;
        objprp.isActive = rblStatus.SelectedValue;
        lblMsg.Text = obj.UpdCollegeType(objprp);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        obj = new clsBLSetup();
        objparm.id = Id;
        lblMsg.Text = obj.DelCollegeType(objparm);
        bindlist();
        txtUserName.Text = "";
        txtUserName.Focus();
        btnDelete.Visible = false;
