...
public partial class Admin_web_EducationType : System.Web.UI.Page
{
    clsBLSetup obj;
    ...
    private void bindlist()
    {
        ...
        objprpdrp.spName = "viewEducationType";
    ...
    private void BindTextboxes()
    {
        ...
        objprp = obj.SelEducationType(objparm);
        Id = objprp.id;
    ...
    private void insertValue()
    {
        ...
        lblMsg.Text = obj.InsEducationType(objprp);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        obj = new clsBLSetup();
        objparm.id = Id;
        lblMsg.Text = obj.DelEducationType(objparm);
        bindlist();
        txtUserName.Text = "";
        txtUserName.Focus();
        btnDelete.Visible = false;
