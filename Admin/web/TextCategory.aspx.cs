...
using nmsSetup;
using nmsDropDown;
public partial class Admin_web_TextCategory : System.Web.UI.Page
{
    clsBLSetup obj;
    ...
    private void bindlist()
    {
        ...
        objprpdrp.spName = "viewTextCategoryWeb";
    ...
    private void BindTextboxes()
    {
        ...
        objprp = obj.SelTextCategoryWeb(objparm);
        Id = objprp.id;
    ...
    private void insertValue()
    {
        ...
        lblMsg.Text = obj.InsTextCategoryWeb(objprp);
    }
    private void updateValue()
    {
        ...
        objprp.uniID = ddlUniversity.SelectedValue;
        objprp.isActive = rblStatus.SelectedValue;
        lblMsg.Text = obj.UpdTextCategoryWeb(objprp);
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        obj = new clsBLSetup();
        objparm.id = Id;
        lblMsg.Text = obj.DelTextCategoryWeb(objparm);
        bindlist();
        txtUserName.Text = "";
        txtUserName.Focus();
        btnDelete.Visible = false;
