...
public partial class Admin_web_UniversityDetail : System.Web.UI.Page
{
    PRPSetup prppram;
    PRPSetup prp;
    clsBLSetup bl;
    ...
    private void bindRankList()
    {
        ...
        ListItem lt1 = new ListItem("University Rank", "0");
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (lblMsg.Text.Substring(0, 17) == "University Submit")
        {
            EmptyTextBox();
    ...
    private void BindTextboxes()
    {
        ...
        prp = bl.SelectUniversityWeb(prppram);
        ...
        lt = ddlUniType.Items.FindByValue(prp.catID);
    ...
    private void UpdateBranch()
    {
        ...
        lblMsg.Text = bl.UpdateUniversityWeb(prp);
    }
