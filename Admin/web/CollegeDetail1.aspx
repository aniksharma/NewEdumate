<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="CollegeDetail1.aspx.cs" Inherits="Admin_web_CollegeDetail" %>
                    ...
                    <td>
                     ...
                     <ContentTemplate>
                        <table>
                            <tr>
                                <td class="H1Center">
                                    <asp:UpdateProgress ID="progressPinChecker" runat="server" AssociatedUpdatePanelID="updatepanel3">
                                        <ProgressTemplate>
                                            &nbsp;
                                        </ProgressTemplate>
                                    </asp:UpdateProgress>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnAddNewEmployee" CausesValidation="false" runat="server" Style="width: 140px;"
                                        CssClass="bnt-sbmt" OnClick="btnAddNewEmployee_Click" Text="Add New College" />
                                </td>
                            </tr>
                            <tr>
                                <td class="H1Center">
