<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminInqueryMaster.master" AutoEventWireup="true" CodeFile="ViewComment.aspx.cs" Inherits="Admin_web_ViewComment" %>
                ...
                <ItemTemplate>
                    <div style="width: 700px; float: left; vertical-align: middle;">
                        <table style="width: 700px; height: 120px;" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:Repeater ID="rptSubDomain" runat="server" DataSource='<%#GetData(Eval("id"))%>'>
                                        <ItemTemplate>
                                            <table>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 50px; color: #0A4F8E; margin-top: 50px;">
                                                        <%#Eval("description")%>
                                                    </td>
                                                </tr>
                                            </table>
