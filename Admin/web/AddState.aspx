<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="AddState.aspx.cs" Inherits="Admin_web_AddState" %>
                                                    ...
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td class="Add-Country" colspan="2">
                                                                Add State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="ImportState.aspx">Import State</a></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                  <asp:DropDownList ID="ddlUniversity" runat="server" CssClass="txt-fld-Dropdown" AutoPostBack="True" onselectedindexchanged="ddlUniversity_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="H1Center" colspan="2">
                                                                <asp:Button ID="btnSubmit" runat="server" CssClass="bnt-sbmt" OnClick="btnSubmit_Click" OnClientClick="ddlChkSelect('State');" onfocus="javascript:submitStatedata();"
