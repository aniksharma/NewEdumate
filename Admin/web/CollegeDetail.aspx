<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master"
    AutoEventWireup="true" CodeFile="CollegeDetail.aspx.cs" Inherits="Admin_web_CollegeDetail" %>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="btnAddNewEmployee" CausesValidation="false" runat="server" Style="width: 140px;"
                                        CssClass="bnt-sbmt" OnClick="btnAddNewEmployee_Click" Text="Add Edu Type" />
                                </td>
                            </tr>
                            <tr>
                                <td class="H1Center">
                                                                        ...
                                                                        <td class="H3Center">
                                                                            <table>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:RadioButtonList ID="RadioButtonList1" RepeatDirection="Horizontal" CssClass="RadioButton"
                                                                                            runat="server" AutoPostBack="True" RepeatLayout="Flow" OnSelectedIndexChanged="RadioButtonList1_SelectedIndexChanged">
                                                                                        ...
                                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="RadioButtonList1"
                                                                                            Display="None" ErrorMessage="Select Type !" SetFocusOnError="True" ValidationGroup="majorUnit">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td width="96%">
                                                                                        <table style="width: 100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="H2Left">
                                                                                                    <asp:Label ID="lblSchoolLevel" runat="server" Text="School Level"></asp:Label>
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                  <asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" CssClass="DropdwonMid"
                                                                                                    ...
                                                                                                    <asp:DropDownList ID="ddlSchoolLevel" runat="server" CssClass="DropdwonMid">                                                                                                      
                                                                                                    </asp:DropDownList>
                                                                                                </td>
                                                                                                <td class="H2Left">
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                   <asp:DropDownList ID="ddlSubCategory" runat="server" AutoPostBack="True" CssClass="DropdwonMid"
                                                                                                     ...
                                                                                                     <asp:DropDownList ID="ddlSchoolSubCategory" runat="server" CssClass="DropdwonMid">                                                                                                      
                                                                                                    </asp:DropDownList>
                                                                                                </td>
                                                                                                <td class="H2Left">
                                                                                                &nbsp;
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                   <asp:DropDownList ID="ddlAffiliated" runat="server" CssClass="DropdwonMid">                                                                                                        
                                                                                                    </asp:DropDownList> 
                                                                                                </td>
                                                                                                <td class="H2Left" id="tdCourseLevel" runat="server">                                                                                                  
                                                                                                   Course Level</td>
                                                                                                <td class="H1Left" id="tdddlCourseLevel" runat="server">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                    ...
                                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtName"
                                                                                                        Display="None" ErrorMessage="University Name !" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                    ...
                                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBranchCode"
                                                                                                        Display="None" ErrorMessage="University Code !" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                                                                            ...
                                                                                            <tr>
                                                                                               <%-- <td class="H2Left" style="display:none;">--%>
                                                                                                ...
                                                                                                <td class="H2Left" id="tdUniverciy" runat="server">
                                                                                                    University:
                                                                                                </td>
                                                                                                <td class="H1Left" id="tdUniverciyDdl" runat="server">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="H2Left" rowspan="2">
                                                                                                 <%--<div style="overflow: scroll; height: 210px; width: 190px;">--%>
