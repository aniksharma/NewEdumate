...
public partial class Admin_web_ImpoartCategory : System.Web.UI.Page
{
    ...
    private void GenerateExcelData()
    {
        ...
        if (fileexns == "xlsx")
        {
            ...
            for (a = 0; a < TotalRow; a++)
            {
                ...
                objprp.uniID = ds.Tables[0].Rows[a][2].ToString();//RadioButtonList1.SelectedValue;
                ...
                objprp.urlPath = "../images/CourseImage/Category.png";
