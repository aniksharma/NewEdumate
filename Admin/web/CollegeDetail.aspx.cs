...
public partial class Admin_web_CollegeDetail : System.Web.UI.Page

{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lblMsg.Text = "";
        lblMsg.CssClass = "lr";
        tdUniverciy.Visible = false;
        tdUniverciyDdl.Visible = false;
        ddlSchoolLevel.Visible = false;
        ddlSchoolSubCategory.Visible = false;
        lblSchoolLevel.Visible=false;
        lblSchoolType.Visible = false;
        ...
        if (RadioButtonList1.SelectedIndex == 0)
        {
            ...
            lblCollegeCategory.Visible = true;
        ...
        if (RadioButtonList1.SelectedIndex == 1)
        {
            ...
            lblCollegeCategory.Visible = false;
            lblCollege.Visible = false;

            ddlSchoolLevel.Visible = true;
            ddlSchoolSubCategory.Visible = true;
            lblSchoolLevel.Visible = true;
            lblSchoolType.Visible = true;
            tdCourseLevel.Visible = false;
            tdddlCourseLevel.Visible = false;

        }
        if (RadioButtonList1.SelectedIndex == 2)
        {

            tdUniverciy.Visible = true;
            tdUniverciyDdl.Visible = true;
    ...
    {
        btnSubmit.Text = "Save";
        // EmployeeDiv.Attributes.Add("display", "block");
    ...
    private void insertBranch(String st )
    {
       ...
       // prp.title = RadioButtonList1.SelectedValue;
        ...
        if (RadioButtonList1.SelectedIndex == 1)
        {
            ...
            prp.sCategory = ddlSchoolLevel.SelectedValue;
            prp.subCategory = ddlSchoolSubCategory.SelectedValue;
            prp.CourseLevel = ddlSchoolLevel.SelectedValue;
        ...
        prp.Affiliated = ddlAffiliated.SelectedValue;
    ...
    private void UpdateBranch( string st  )
    {
        ...
        prp.isActive = rblStatus.SelectedValue;
        prp.address = txtAddress.Text;
       // prp.city = txtCity.Text;
      //  prp.district = txtDisrict.Text;
      //  prp.state = txtState.Text;
        prp.phoneNo = txtPhone.Text;
        prp.mobNo = txtmobNo.Text;
        prp.mailId = txtMailId.Text;
        prp.DOJ = txtDate.Text;
    ...
    protected void RadioButtonList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (RadioButtonList1.SelectedIndex == 0)
        {
            ...
            lblSchoolLevel.Visible = false;
            lblSchoolType.Visible = false;
            tdCourseLevel.Visible = true;
            tdddlCourseLevel.Visible = true;
   ...
   private void BindSubCategory()
    ...
    #region Bind  Affiliated,Level,TypeOfSchool  for School
     private void BindAffiliated()
        {
            clsBLdropDown objdrp = new clsBLdropDown();
            clsPRPdropdown objprpdrp = new clsPRPdropdown();
            objprpdrp.controlList = ddlAffiliated;
            //if (RadioButtonList1.SelectedIndex != 0)
                objprpdrp.id = Convert.ToInt32(RadioButtonList1.SelectedValue);
                objprpdrp.Type = ddlUniversity0.SelectedValue;
                objprpdrp.spName = "SpGetAffiliatedDetails";
            //if (objprpdrp.id == 2)
            //{
            //    objprpdrp.spName = "SpGetAffiliatedDetails";
            //}
        ...
        private void BindLevel()
        {
            clsBLdropDown objdrp = new clsBLdropDown();
            clsPRPdropdown objprpdrp = new clsPRPdropdown();
            objprpdrp.controlList = ddlSchoolLevel;
            if (RadioButtonList1.SelectedIndex != 0)
