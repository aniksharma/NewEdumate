<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminInqueryMaster.master" AutoEventWireup="true" CodeFile="InqueryForm.aspx.cs" Inherits="Admin_web_InqueryForm" %>
                                            ...
                                            <td align="center" style="width: 96%">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="width: 25%">
                                                            <asp:DropDownList ID="ddlNopage" runat="server" Width="75" CssClass="DropdwonShort" OnSelectedIndexChanged="ddlNopage_SelectedIndexChanged"
                                                                AutoPostBack="True">
         ...
         Query Regarding
             ...
             Mobile
               ...
               <th>
                ...
                <td><%#Eval("state")%></td>
                <td><%#Eval("district") %></td>
                <td><%#Eval("durationMinTime")%></td>
                <td><%#Eval("durationMaxTime")%></td>
                <td><%#Eval("Query")%></td>
                <td valign="top">
                <%#Eval("status")%>
                </td>
                ...
                <td>                
                <asp:LinkButton ID="lnkDelete" CommandName="Delete" CommandArgument='<%#Eval("id")%>' runat="server">Delete</asp:LinkButton></td>
                </tr>
                </ItemTemplate>
