<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SchoolListing.aspx.cs" Inherits="Admin_web_SchoolListing" %>
                        ...
                        <table style="width: 100%;" class="minHeight">
                            <tr>
                                <td>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;<a href="importSchool.aspx">Import School</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="H1Center">
                                                                                    ...
                                                                                    <td width="96%">
                                                                                        <table style="width: 100%">
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="H1Left">
                                                                                                 <asp:DropDownList ID="ApprovedBy" runat="server" CssClass="DropdwonMid" OnSelectedIndexChanged="ApprovedBy_SelectedIndexChanged">                                                                                                        
                                                                                                    </asp:DropDownList>
                                                                                                </td>
                                                                                                <td class="H2Left">
