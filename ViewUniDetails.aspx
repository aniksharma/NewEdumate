<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewUniDetails.aspx.cs" Inherits="ViewUniDetails" %>
                ...
                <% 
                   if (TotalCount > 0)
                    
                    {
                        ...
                        string linkuniname = ds.Tables[0].Rows[0]["uniName"].ToString();
                        string linkemail = ds.Tables[0].Rows[0]["uniEmailID"].ToString();
                        string linkaddress = ds.Tables[0].Rows[0]["uniAddress"].ToString();
                        string linkimage = ds.Tables[0].Rows[0]["imagePath"].ToString();

                        string TextTitle = ds.Tables[0].Rows[0]["textTitle"].ToString();
                        string TextDetails = ds.Tables[0].Rows[0]["textDescription"].ToString();
                        string UniWebsite = ds.Tables[0].Rows[0]["UniWebsite"].ToString();

                        string uniID = ds.Tables[0].Rows[0]["uniID"].ToString();
    ...
    <div class="tab_container" id ="tyty" style="display:block; width:680px;overflow-y:scroll;min-height:200px;max-height:210px;">
     ...
     %>
         ...
         <span class="image-block">
					<a class="image-zoom" href="~/<%=Title%>" rel="prettyPhoto[gallery]" title="College Gallery">
                        <img width="225" height="140" src="~/<%=Title%>" alt="College Gallery" title="College Gallery" />                    
                    </a>
                    </span>
